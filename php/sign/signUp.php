...
<body>
    ...
    <main>
        ...
        <section id="signUpCont">
             <div class="signUp">
                 <h1><strong>minjoo</strong> 사이트에 오신걸 환영합니다</h1>
                 <form name="signUp" method="post" action="signUpSave.php">
                     <fieldset>
                         ...
                         <div>
                             ...
                             <input type="text" name="userNickName" id="userNickName" class="input-text" placeholder="닉네임을 적어주세요" required>
                         </div>
                         <div>
